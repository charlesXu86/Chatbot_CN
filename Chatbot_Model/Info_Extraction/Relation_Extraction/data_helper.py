...
def init():
    ...
    relation2id = {}
    f = open('Chatbot_Data/Info_Extraction/re_extraction/relation2id.txt', 'r', encoding='utf-8')
    while True:
        content = f.readline()
        if content == '':
            break
    ...
    f = open('Chatbot_Data/Info_Extraction/re_extraction/train.txt', 'r', encoding='utf-8')
    while True:
        content = f.readline()
        if content == '':
            break
    ...
    f = open('Chatbot_Data/Info_Extraction/re_extraction/test.txt', 'r', encoding='utf-8')
